...
def _summarize_run(run_name: str, *, result_root: Path, analysis: dict | None = None) -> dict:
    ...
    return {
        ...
        "action_selection_relaxed_diagnostics_enabled_count": runtime.get("action_selection_relaxed_diagnostics_enabled_count", action_selection_metrics["action_selection_relaxed_diagnostics_enabled_count"]),
        "action_selection_relaxed_region_signature_count": runtime.get("action_selection_relaxed_region_signature_count", action_selection_metrics["action_selection_relaxed_region_signature_count"]),
        "action_selection_relaxed_span_signature_count": runtime.get("action_selection_relaxed_span_signature_count", action_selection_metrics["action_selection_relaxed_span_signature_count"]),
        "action_selection_relaxed_inverse_loop_signature_count": runtime.get("action_selection_relaxed_inverse_loop_signature_count", action_selection_metrics["action_selection_relaxed_inverse_loop_signature_count"]),
        "action_selection_relaxed_current_candidate_match_count": runtime.get("action_selection_relaxed_current_candidate_match_count", action_selection_metrics["action_selection_relaxed_current_candidate_match_count"]),
        "action_selection_relaxed_inverse_loop_candidate_count": runtime.get("action_selection_relaxed_inverse_loop_candidate_count", action_selection_metrics["action_selection_relaxed_inverse_loop_candidate_count"]),
        "action_selection_relaxed_all_candidates_match_count": runtime.get("action_selection_relaxed_all_candidates_match_count", action_selection_metrics["action_selection_relaxed_all_candidates_match_count"]),
        "action_selection_relaxed_would_suppress_candidate_count": runtime.get("action_selection_relaxed_would_suppress_candidate_count", action_selection_metrics["action_selection_relaxed_would_suppress_candidate_count"]),
        "action_selection_relaxed_no_candidate_signature_count": runtime.get("action_selection_relaxed_no_candidate_signature_count", action_selection_metrics["action_selection_relaxed_no_candidate_signature_count"]),
